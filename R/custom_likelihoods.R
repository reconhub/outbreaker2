...
#'
#' @seealso For examples on customizing likelihoods, see
#'   \url{http://www.repidemicsconsortium.org/outbreaker2/articles/customisation.html#customizing-likelihood}.
#'
#' @export
#'
#' @examples
