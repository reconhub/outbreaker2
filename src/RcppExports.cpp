...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< SEXP >::type i(iSEXP);
    Rcpp::traits::input_parameter< Rcpp::RObject >::type custom_function(custom_functionSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_ll_patient_transfer(data, param, i, custom_function));
    return rcpp_result_gen;
END_RCPP
}
// cpp_ll_potential_colonised
double cpp_ll_potential_colonised(Rcpp::List data, Rcpp::List param, SEXP i, Rcpp::RObject custom_function);
RcppExport SEXP _outbreaker2_cpp_ll_potential_colonised(SEXP dataSEXP, SEXP paramSEXP, SEXP iSEXP, SEXP custom_functionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type param(paramSEXP);
    Rcpp::traits::input_parameter< SEXP >::type i(iSEXP);
    Rcpp::traits::input_parameter< Rcpp::RObject >::type custom_function(custom_functionSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_ll_potential_colonised(data, param, i, custom_function));
    return rcpp_result_gen;
END_RCPP
}
// cpp_ll_all
...
// cpp_move_sigma
Rcpp::List cpp_move_sigma(Rcpp::List param, Rcpp::List data, Rcpp::List config, Rcpp::RObject custom_ll, Rcpp::RObject custom_prior);
RcppExport SEXP _outbreaker2_cpp_move_sigma(SEXP paramSEXP, SEXP dataSEXP, SEXP configSEXP, SEXP custom_llSEXP, SEXP custom_priorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type param(paramSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::RObject >::type custom_ll(custom_llSEXP);
    Rcpp::traits::input_parameter< Rcpp::RObject >::type custom_prior(custom_priorSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_move_sigma(param, data, config, custom_ll, custom_prior));
    return rcpp_result_gen;
END_RCPP
}
// cpp_move_eps
...
// cpp_prior_sigma
double cpp_prior_sigma(Rcpp::List param, Rcpp::List config, Rcpp::RObject custom_function);
RcppExport SEXP _outbreaker2_cpp_prior_sigma(SEXP paramSEXP, SEXP configSEXP, SEXP custom_functionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type param(paramSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type config(configSEXP);
    Rcpp::traits::input_parameter< Rcpp::RObject >::type custom_function(custom_functionSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_prior_sigma(param, config, custom_function));
    return rcpp_result_gen;
END_RCPP
}
// cpp_prior_eps
