...
test_that("Test cpp_ll_genetic", {
  ...
  expect_equal(
    cpp_ll_genetic(data, param_star, 1:10),
...
test_that(paste(
  "Arity of custom likelihood functions is passed, and they are called",
  ...
  ## Generate custom functions with 2 arguments
  f2 <- function(data, param) {
    return(2)
  }

  arity_two <- custom_likelihoods(
    genetic = f2,
  ...
  f3 <- function(data, param, i = -1) {
    return(i)
  }

  arity_three <- custom_likelihoods(
    genetic = f3,
