...
- a new movement of ancestries in which a 'good' transmission tree is used as
  proposal
...
known and can be directly sampled from. He, we use this principle to provide a
toy example of custom movemet for `mu`, assuming that this conditional
