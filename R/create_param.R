...
#'
#'  \item \code{sigma}: A numeric vector of length \code{size}, storing values of
#' the hospital transfer probability.
#'
...
#' 
#'  \item \code{sigma}: The value of the hospital transfer probability.
#' 
